...
print("Total program runtime: {} seconds.".format(time.time() - TOTAL_START_TIME))
   ...
   : 0.00034046173095703125 seconds for creating dict of matrix lists
   : 0.010339975357055664 seconds for saving dict to json
   : 1.2159347534179688e-05 seconds for random key query
   : 0.03429579734802246 seconds for creating dict of nullspace vectors
   : 0.005727291107177734 seconds for saving dict to json
   : 7.3909759521484375e-06 seconds for random key query
   : Filesize of ../matrix_dict_lists.json 0.035279273986816406 MB
   : Filesize of ../matrix_dict_lists.json 0.021460533142089844 MB
   : Total program runtime: 0.05086922645568848 seconds.
